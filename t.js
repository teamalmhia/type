...
$(`<center>
 ...
 <style> 
  .clr_cls { 
   background-color: red; border: 3px double #f04713;
...
<body> 
 <div class="clr_cls">
<center><div><marquee direction="right" width="99%" id="n1w8" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="5">  &nbsp;●・🌹🌹 اهلا وسهلا بكم في شات 🌹🌹・●  <font style="background-color: #fff;border-radius: 30px 40px 40px 30px;" color="#0000ff"</font>🌟💝
